...
public class CreateWaitSizeJobActivity implements BotActivity {
	...
	private String getSize(List<String> messages) {
	...
	private String getUrl(List<String> messages) {
		for(String msg : messages) {
	...
	private String getShop(String url) {
